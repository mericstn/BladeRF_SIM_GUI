...
namespace bladeRF_GUI_v1.ApplicationUserControls
{
    public partial class UC_Yazma : UserControl
    {
        ...
        private void guncelle()
        {
            ...
            tx_frekans_textbox.Text             = c_yazma.tx_frekans;
            tx_ornekleme_orani_textbox.Text     = c_yazma.tx_ornekleme_orani;
            tx_bant_genisligi_textbox.Text      = c_yazma.tx_bant_genisligi;
            tx_anten_kazanci_textbox.Text       = c_yazma.tx_anten_kazanci;
            tx_zaman_asimi_textbox.Text         = c_yazma.tx_zaman_asimi;
            tx_biastee_checkbox.Text            = c_yazma.tx_biastee;
            tx_kanal_combobox.SelectedIndex     = 0;
            tx_okunacak_dosya_adi_textbox.Text  = c_yazma.tx_okunacak_dosya_adi;

            vap_tampon_sayisi_textbox.Text        = c_yazma.vap_tampon_sayisi;
            vap_tampon_boyutu_textbox.Text        = c_yazma.vap_tampon_boyutu;
            vap_veri_transfer_sayisi_textbox.Text = c_yazma.vap_veri_transfer_sayisi;
            vap_zaman_asimi_textbox.Text          = c_yazma.vap_zaman_asimi;
        }
        ...
        private void tx_biastee_checkbox_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                c_yazma.tx_biastee = "Aktif";
            }
            else
            {
                c_yazma.tx_biastee = "Kapali";
            }
            tx_biastee_checkbox.Text = c_yazma.tx_biastee;
        }
        ...
        {
            c_yazma.vap_tampon_sayisi = vap_tampon_sayisi_textbox.Text;
        }

        private void vap_tampon_boyutu_textbox_TextChanged(object sender, EventArgs e)
        {
            c_yazma.vap_tampon_boyutu = vap_tampon_boyutu_textbox.Text;
        }

        private void vap_veri_transfer_sayisi_textbox_TextChanged(object sender, EventArgs e)
        {
            c_yazma.vap_veri_transfer_sayisi = vap_veri_transfer_sayisi_textbox.Text;

        }

        private void vap_zaman_asimi_textbox_TextChanged(object sender, EventArgs e)
        {
            c_yazma.vap_zaman_asimi = vap_zaman_asimi_textbox.Text;
