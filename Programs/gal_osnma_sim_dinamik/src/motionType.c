 ...
 */
static inline void comptPos(double * xyz, double tx, const ecef_t p0, const ecef_t v0, double t0){ // xyz[i] nin []
	xyz[0] = p0[0] + v0[0] * (tx - t0);
	xyz[1] = p0[1] + v0[1] * (tx - t0);
	xyz[2] = p0[2] + v0[2] * (tx - t0);
}

void getPos(double * xyz, double tx, const motionStr_t* mt) {
    ecef_t p0={0};
    ecef_t v0={0};
    double t0=0;
